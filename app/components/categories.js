...
let row = props.data.map((current,index) =>{
    ...
    return ( 
        <section className="category flex flex-col w-11/12 mb-9 text-gray-950 md:w-10/12 divide-x">
            ...
            <div className="item-holder  flex flex-row overflow-x-scroll overflow-y-clip   p-2 shrink-0 outline-none border-none scroll-m-2">
